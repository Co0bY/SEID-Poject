        ...
        <div class="row">
            ...
            <div class="col">
                <div class=" card">
                    <div class=" card-body">
                        <div class=" row">
                            <h1 class=" text-uppercase m-3">Formulario de Reativação</h1>
                        </div>

                        {{-- route('pesquisar') --}}
                        <form action="{{ route('secretary.registration-reactive') }}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    ...
                                    <input type="text" class=" form-control" id="cpf" name="cpf" readonly value="{{$registration->student->cpf }}">
                                ...
                                <div class="col mb-3">
                                    ...
                                    <input type="text" class=" form-control" id="code" name="code" readonly value="{{$registration->season->code}}">
                                    <div class="mt-1" style="color: red" role="alert">
                                        @if($errors->has('code'))
                                        {{$errors->first('code')}}
                                        @endif
                                ...
                                <div class="col mb-3">
                                    ...
                                    <input type="text" class=" form-control" id="course_code" name="course_code" readonly value="{{ $registration->course_code}}">
                                    <div class="mt-1" style="color: red" role="alert">
