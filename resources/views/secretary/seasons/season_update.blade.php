                        ...
                        <form action="{{ route('secretary.season-create') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col mb-3"><label for=""
                                    ...
                                    <input type="text" class=" form-control" id="discipline_name" name="name" value="{{old('name') ?? $season->name}}">
                            ...
                            <div class="row">
                                <div class="col mb-3"><label for="" class=" text-dark text-uppercase text-bold">Data
                                        de
                                        Inicio</label>
                                    <input type="date" class=" form-control" id="start_date" name="start_date" value="{{old('start_date') ?? $season->start_date}}">
                                    <div class="mt-1" style="color: red" role="alert">
                                ...
                                <div class="col mb-3"><label for="" class=" text-dark text-uppercase text-bold">Data
                                        de
                                        Encerramento</label>
                                    <input type="date" class=" form-control" id="end_date" name="end_date"  value="{{old('end_date') ?? $season->end_date}}">
                                    <div class="mt-1" style="color: red" role="alert">
                            ...
                            <div class="row">
                                <div class="col mb-3"><label for=""
                                        ...
                                        do Período</label>
                                    <input type="text" class=" form-control" id="code" name="code"  value="{{old('code') ?? $season->code}}">
                                    <div class="mt-1" style="color: red" role="alert">
                                        @if($errors->has('code'))
                                        {{$errors->first('code')}}
                                        @endif
