            ...
            <div class="col">
                <div class=" card">
                    <div class=" card-body">
                        ...
                        <form action="{{ route('secretary.season-reactive') }}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="alert alert-warning justify-content-center text-align-center" role="alert">
                                        Reativando esse período você também vai reativar todas as matriculas e turmas ligadas a esse periodo.
                                    </div>
                                </div>
                            </div>
                            <div class="row">
