...
@section('content')
    ...
    <div class="modal fade" id="modaDataVazia" tabindex="-1" role="dialog" aria-labelledby="modalAguardeExportacao"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    É necessário especificar um período inicial e um período final <span class="bold">OU</span> fornecer a
                    Mátricula de um aluno para seguir com a exportação!
                </div>
    ...
    <div class="modal fade" id="modaNotas" tabindex="-1" role="dialog" aria-labelledby="modalAguardeExportacao"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
